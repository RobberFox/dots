#!/bin/sh
sudo apt install psmisc htop xinput build-essential fd-find ripgrep python3 pipx npm awesome zathura texlive-full flameshot krita inkscape mpv xserver-xephyr
